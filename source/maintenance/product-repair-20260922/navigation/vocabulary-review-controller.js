(() => {
  ...
  host.replaceChildren();const links=el('nav','','word-tool-links');for(const [id,label] of [['word-review','开始复习'],['topical-vocabulary','话题词卡'],['lookup-history','查词历史']]){const a=el('a',label);a.href='#'+id;links.append(a);}host.append(links);
