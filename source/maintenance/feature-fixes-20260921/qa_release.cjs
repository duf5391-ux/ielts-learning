...
async function main(){
 ...
 assert.equal(await page.locator('[data-save]').count(),3368);assert.equal(await page.locator('[data-learning-unit]').count(),224);add('All 3368 saved fields and 224 learning units assembled');
