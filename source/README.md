...
本分支保存正式源码及维护、探针材料。2026-09-22源码已同步最新正式册 `a96477bc…`，对应已成功部署的主分支提交 `c0b266147da2c484641f5f8dca12e2ee78a74ffe`。本源码分支的 `site/` 保留旧版；预览最新完整站点请使用 `main` 分支。
...
本轮前端与交互见 [自测、写作与双端UI](maintenance/ui-experience-20260922/README.md)、[本轮关系图](maintenance/ui-experience-20260922/interface-tensor.html)。候选、发布包、HTTPS各43项检查通过，Kimi App K3提供评审。

## 从这里开始

- [正式整页源码](production/开始学习.html)：SHA-256 `a96477bc2cab9a26764a8b19af06f2ccb701ac4e0b986504432431628b318ae1`，4092个保存字段、236个目录单元。
